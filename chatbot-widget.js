...
function startConversation() {
    fetch('https://chatbot-for-first-step-learning-center-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-first-step-learning-center-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbw5ld21ZRj1dpcarBCMCbPKEtZyZ9GhdLDNeMYH2YZCYgyiJ4Kl5BzbIL38eW-UwQze/exec';
